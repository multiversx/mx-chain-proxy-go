...
type TransactionProcessorStub struct {
	...
	GetProcessedTransactionStatusCalled         func(txHash string) (*data.ProcessStatusApiResponse, error)
...
func (tps *TransactionProcessorStub) GetProcessedTransactionStatus(txHash string) (*data.ProcessStatusApiResponse, error) {
	if tps.GetProcessedTransactionStatusCalled != nil {
		return tps.GetProcessedTransactionStatusCalled(txHash)
	}

	return &data.ProcessStatusApiResponse{}, errNotImplemented
}
