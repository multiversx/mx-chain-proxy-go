...
type Facade struct {
	...
	SendMultipleTransactionsHandler  func(txs []*data.Transaction) (data.ResponseMultiTransactions, error)
...
func (f *Facade) SendMultipleTransactions(txs []*data.Transaction) (data.ResponseMultiTransactions, error) {
