...
func NewNodeStatusProcessor(
	...
	return &NodeStatusProcessor{
		...
		snapshots: []string {
			"snapshot-10-2021-05-24-11-58-03.json",
			"snapshot-10-2021-05-24-13-01-26.json",
			"snapshot-10-2021-05-24-14-09-03.json",
			"snapshot-10-2021-05-24-15-07-24.json",
			"snapshot-10-2021-05-24-16-58-02.json",
			"snapshot-10-2021-05-24-17-59-34.json",
			"snapshot-10-2021-05-24-19-29-44.json",
		},
	}, nil
}
...
//	// Create final file - do this first, since if it errors, there's no point in doing all the work
//	file, err:= core.CreateFile(core.ArgCreateFileArgument{
//		Directory: "/home/ubuntu/snapshots/week5",
//		Prefix: "snapshot-10",
//		FileExtension: "json",
//	})
//	if err != nil {
...
func (nsp *NodeStatusProcessor) computeMexValues(snapshotItems []*data.SnapshotItem) ([]*data.MexItem, error) {
	...
	weekOneMexApproxValue, _ := big.NewFloat(0).SetString("25200000000000000000000000")
...
func (nsp *NodeStatusProcessor) loadLocalSnapshots() ([][]*data.SnapshotItem, error) {
	...
	for i := 0; i < len(nsp.snapshots); i++ {
		...
		err := core.LoadJsonFile(&snapshot, "/home/ubuntu/snapshots/week5/" + nsp.snapshots[i])
		if err != nil {
