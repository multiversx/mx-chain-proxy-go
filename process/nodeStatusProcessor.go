...
func NewNodeStatusProcessor(
	...
	return &NodeStatusProcessor{
		...
		snapshots: []string {
			"snapshot-10-2021-07-06-07-48-16.json",
			"snapshot-10-2021-07-06-08-46-45.json",
			"snapshot-10-2021-07-06-09-29-43.json",
			"snapshot-10-2021-07-06-10-08-18.json",
			"snapshot-10-2021-07-06-10-56-56.json",
			"snapshot-10-2021-07-06-11-41-15.json",
			"snapshot-10-2021-07-06-12-17-20.json",
		},
	}, nil
}
...
func (nsp *NodeStatusProcessor) CreateSnapshot(timestamp string) (*data.GenericAPIResponse, error) {
	// Create final file - do this first, since if it errors, there's no point in doing all the work
	file, err:= core.CreateFile(core.ArgCreateFileArgument{
		Directory: "/home/ubuntu/snapshots/week12",
		Prefix: "snapshot-10",
		FileExtension: "json",
	})
	if err != nil {
...
func (nsp *NodeStatusProcessor) loadLocalSnapshots() ([][]*data.SnapshotItem, error) {
	...
	for i := 0; i < len(nsp.snapshots); i++ {
		...
		err := core.LoadJsonFile(&snapshot, "/home/ubuntu/snapshots/week11/" + nsp.snapshots[i])
		if err != nil {
