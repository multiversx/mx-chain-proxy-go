...
func NewNodeStatusProcessor(
	...
	return &NodeStatusProcessor{
		...
		snapshots: []string {
			"snapshot-10-2021-06-30-07-14-34.json",
			"snapshot-10-2021-06-30-17-18-17.json",
			"snapshot-10-2021-07-01-06-58-04.json",
			"snapshot-10-2021-07-01-07-48-31.json",
			"snapshot-10-2021-07-01-08-37-04.json",
			"snapshot-10-2021-07-01-09-41-54.json",
			"snapshot-10-2021-07-01-10-29-52.json",
		},
	}, nil
}
...
//	// Create final file - do this first, since if it errors, there's no point in doing all the work
//	file, err:= core.CreateFile(core.ArgCreateFileArgument{
//		Directory: "/home/ubuntu/snapshots/week10",
//		Prefix: "snapshot-10",
//		FileExtension: "json",
//	})
//	if err != nil {
...
func (nsp *NodeStatusProcessor) loadLocalSnapshots() ([][]*data.SnapshotItem, error) {
	...
	for i := 0; i < len(nsp.snapshots); i++ {
		...
		err := core.LoadJsonFile(&snapshot, "/home/ubuntu/snapshots/week10/" + nsp.snapshots[i])
		if err != nil {
